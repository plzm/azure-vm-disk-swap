...
remoteCmdVm1="'touch i_was_here_1.txt; sudo mkdir /plzm_was_here_1;'" # Of course you can modify this remote cmd script to add config or install or other steps as needed before deprovisioning
